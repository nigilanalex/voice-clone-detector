...
- Uploaded WAV, MP3, M4A, AAC, FLAC, OGG, and OPUS recordings
...
2. Uploaded recordings are capped at 25 MB and 10 minutes.
...
4. The pinned Wav2Vec2 classifier scores each window using the checkpoint's declared
   fake label; VoiceGuard averages those model scores.
...
After the handshake, send mono signed 16-bit little-endian PCM binary frames. The
